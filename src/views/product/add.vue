<template>
  <el-card class="box-card product-edit">
    ...
    <el-form label-width="95px" :model="goods" style="width: 60%">
      ...
      <el-form-item>
        <el-button type="primary" @click="onSubmit">立即修添加</el-button>
...
export default {
  ...
  data() {
    return {
      goods: {
        imgUrl:
          "http://img11.360buyimg.com/n7/jfs/t1/163696/36/10396/382600/6045980aEb48d2cc8/858dd819bb35f44e.jpg",
  ...
  methods: {
    ...
    onSubmit() {
      ...
      if (count <= 1) {
        productRequest.addProductRowInfo(this.goods).then((res) => {
          if (res.code == 666) {
